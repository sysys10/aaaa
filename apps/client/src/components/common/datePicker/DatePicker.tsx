...
const CustomDatePicker = ({
  ...
  const renderCustomInput = ({
    ...
    <button
      className='min-w-[13.5rem] justify-between ml-2 p-2 text-center flex items-center bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500'
      onClick={onClick}
    >
      {value ? value : '전체기간'}
