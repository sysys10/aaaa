...
const WeekPicker = ({ onClose, initialDate }: WeekPickerProps) => {
  ...
  const renderCustomInput = ({
    ...
    <button
      className='!text-xs w-fit p-1.5 text-left flex items-center justify-center gap-1.5 bg-white border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500'
      onClick={onClick}
    >
      {value}
