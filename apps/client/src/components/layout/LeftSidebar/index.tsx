    ...
    () => (
      ...
      >
        ...
        <div className='relative'>
          <div
            className={`${isSidebarOpen ? 'w-sidebar-width' : 'w-0 overflow-x-hidden'} transition-[width] duration-[400ms]`}
          >
            <div
              className={`relaitve h-screen w-full pt-20 bg-background-primary border-r whitespace-nowrap`}
            >
