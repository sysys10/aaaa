...
var __vite_injected_original_dirname = "/Users/yunsu/Documents/aicfo/aicfo2_mono/apps/client";
var vite_config_default = defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@apis", replacement: path.resolve(__vite_injected_original_dirname, "src/apis") },
      { find: "@pages", replacement: path.resolve(__vite_injected_original_dirname, "src/pages") },
      { find: "@helper", replacement: path.resolve(__vite_injected_original_dirname, "src/helper") },
