...
const DayPicker = ({ onClose, initialDate }: DatePickerBaseProps) => {
    ...
    <div className='w-full'>
      ...
      {isOpen && (
        ...
        >
          <div
            ref={sheetRef}
            className='w-full bg-white rounded-t-2xl transform translate-y-full transition-transform duration-300 ease-in-out'
