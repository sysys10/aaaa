  ...
  return (
    <div
      ...
      className={`rounded-md shadow-sm border ${
        alarm.useReadYn === 'N' ? 'bg-[rgba(79,99,210,0.10)]' : 'bg-white'
      }`}
    >
      <div className='p-2'>
        ...
        {isOpen && (
          <div className='items-center space-x-1 bg-[#F5F5F5] border-t border-gray-400 p-3'>
            <div className='flex flex-col items-center space-x-1 p-4 w-full bg-white rounded-md'>
