    ...
    <div className='mt-topbar-height px-6 pt-6 space-y-2 h-full w-full bg-[#F5F5F5]'>
      ...
      >
        ...
        <div className='flex-1 px-2'>
          <p className='text-base font-semibold'>자금 일보</p>
      ...
      >
        ...
        ></div>
        <div className='flex-1 px-2'>
          <p className='text-base font-semibold'>자금 주보</p>
      ...
      >
        ...
        ></div>
        <div className='flex-1 px-2'>
          <p className='text-base font-semibold'>자금 월보</p>
      ...
      >
        ...
        ></div>
        <div className='flex-1 px-2'>
          <p className='text-base font-semibold'>일일 시재 마감</p>
